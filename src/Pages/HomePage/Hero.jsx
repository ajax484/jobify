...
const HeroLeft = () => (
    <div className="relative flex flex-col items-center justify-end lg:justify-center pb-5 md:pb-10 lg:pb-0 lg:px-0 lg:pl-8 text-center lg:text-left">
        <h1 className="text-4xl md:text-5xl lg:text-[3.75rem] font-primaryExtraBold md:leading-tight mb-2 md:mb-4">Find your dream job with us</h1>
        <p className="text-sm md:text-base lg:text-lg mb-4 md:mb-8 text-gray-800">
